...
@Autonomous(name = "(DE LADO) VERMELHO 1C", group = "Autonomo")
public class VERMELHO_1C extends LinearOpMode {
    // setup base
    ...
    public void runOpMode() {
        ...
        // vá em direção aos patos (talvez atropele os patos)
        ...
        autonomousModule.MoverBraço(robot.atuadores, 0.25);
